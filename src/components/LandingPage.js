...
function LandingPage() {
  return (
    <div className='relative top-[3vw] flex text-white h-[35vw]' style={{backgroundImage: 'linear-gradient( 90.1deg,  rgba(84,212,228,1) 0.2%, rgba(68,36,164,1) 99.9% )'}}>
     <div className=' mx-12 slideleft'>
      ...
      <div className='mx-2 flex mt-12 space-x-8 relative top-[14rem] slideleft'>
     ...
     <div className='flex w-1/2'><img className='m-auto slideright' src="./resume-img.png" alt="" /></div>
    </div>
  )
}
